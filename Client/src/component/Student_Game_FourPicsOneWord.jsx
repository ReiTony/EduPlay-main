...
function Student_Game_FourPicsOneWord() {
  ...
  const handleSubmitAnswer = (e) => {
    e.preventDefault();
    if (roundNumber + 1 === data.rounds.length) return alert("Tapos na ang 4Pics1Word, what to do next?");
  ...
  return (
    <div className="bg-[#fff5be] flex flex-col m-4 mb-6 p-8 rounded-2xl h-full">
      ...
      <div className="flex flex-col justify-center items-center py-4 h-full">
        <img className={isImageLoaded ? "" : "loading"} src={data?.rounds[roundNumber].imagePath} style={{ height: "500px" }} onLoad={() => setIsImageLoaded(true)} />
