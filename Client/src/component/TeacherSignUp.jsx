                        ...
                        <div>
                            ...
                            <form action='' onSubmit={handleSubmit} >
                                <div className='flex justify-center gap-2 mt-8'>
                                    ...
                                    {/* First Name input */}
                                    <input className={`w-[100%] rounded-full flex p-4 px-10 text-4xl border-2 bg-[#252525] text-white placeholder-white font-kumbh
                                    ...
                                    {/* Last Name input */}
                                    <input className={`w-[100%] justify-center p-4 px-10 flex items-center rounded-full border-2 text-4xl bg-[#252525] text-white placeholder-white font-kumbh
                                ...
                                {/* Sign-up button */}
                                <button className="w-[50%] font-sourceSans3 text-center rounded-full p-2  mt-10 text-5xl bg-[#252525]  shadow-lg  text-white placeholder-white font-bold"
                                    type="submit">
                                    SIGN UP
                                </button>
                            </form>
