    ...
    <>
      <div className="flex flex-col justify-between min-h-screen background">
        ...
        <main className="w-[80%] md:w-[80%] lg:w-[70%] xl:w-[60%] text-center grid lg:grid-cols-[35%_65%] m-auto ">
          ...
          <section className="bg-[#f0e4e4] opacity-95 flex flex-col py-4 justify-center rounded-r-lg lg:rounded-l-none rounded-lg lg:px-16 py-auto shadow-2xl shadow-black">
