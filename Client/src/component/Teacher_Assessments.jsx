      ...
      <div className="flex flex-col flex-grow gap-4">
        ...
        <div className="mx-2 flex flex-col flex-grow gap-4 p-2 sm:p-5 font-bold backgroundGreen rounded-3xl">
          <div className="flex flex-row flex-wrap-reverse justify-end gap-4 text-xl sm:text-2xl">
            ...
            <button
              className="bg-[#282424] rounded-xl m-4 sm:m-2 px-8 py-2 text-white font-bold hover:brightness-90 hover:scale-[.99] transition-transform transform-gpu hover:shadow-green-500 shadow-black shadow-lg"
