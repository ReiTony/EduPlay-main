    ...
    <div className="flex justify-center min-h-screen background">
      ...
      <main className="w-full md:w-[80%] lg:w-[70%] xl:w-[60%] text-center grid grid-cols-[35%_65%] mt-24 mb-16">
        ...
        <section className="bg-[#f7d538] opacity-95 flex flex-col gap-14 justify-center px-16 py-4">
          <h2 className="font-extrabold px-14 text-6xl font-expletus my-8">
            Student Login
          </h2>
          <form onSubmit={handleSubmit}>
            <label
              ...
              className={`block mb-2 text-xl font-semibold ${
                touched.username && errors.username ? "text-red-500" : ""
              }`}
            >
              Username
            </label>
            <input
              ...
              name="username"
              type="text"
              className={`w-[100%] rounded-full flex p-4 px-10 mt-2 text-xl bg-black text-white border-2 font-kumbh ${
            ...
            <label
              htmlFor="password"
              className={`block mt-4 mb-2 text-xl font-semibold ${
            ...
            <div className="relative">
              <input
                ...
                className={`w-[100%] justify-center flex items-center rounded-full px-10 border-2 p-4 text-xl bg-black text-white font-kumbh ${
