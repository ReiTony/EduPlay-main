      ...
      <main className="w-full md:w-[80%] lg:w-[70%] xl:w-[60%] m-4 text-center   grid grid-cols-[35%_65%] ">
        ...
        <div className="flex flex-row justify-center bg-white opacity-95">
          <div>
            ...
            <div>
              <form className="">
                <input className="w-[100%] rounded-full flex p-4 mt-8 text-4xl bg-black text-white placeholder-white font-kumbh" id="username" type="text" placeholder="Email"></input>

                <input className="w-[100%] justify-center flex items-center rounded-full   p-4 mt-8 text-4xl bg-black text-white placeholder-white font-kumbh" id="password" type="password" placeholder="Password"></input>

                <div class="flex justify-around mt-2 ">
                  <div class="mb-6  ">
                    <label class="block font-bold text-gray-500">
                      <input class="leading-tight " type="checkbox"></input>
                      <span class="text-lg ml-1 ">Remember me</span>
                    </label>
                  </div>
