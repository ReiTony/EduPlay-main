    ...
    <>
      <div className="backgroundYellow">
        <main className="flex flex-col p-5 gap-3">
          ...
          <div className="backgroundGreen h-[24rem] relative rounded-xl ">
            <div className="absolute p-8 text-3xl font-bold tracking-wider text-white lg:text-6xl font-sourceSans3">
              <h1>Creating</h1> <br />
            ...
            <div className="absolute bottom-0 right-0 p-4">
              <a href="/teacher/assessments">
                <button className="bg-green-700 hover:bg-green-800 shadow-lg shadow-black flex items-center lg:text-5xl text-white font-bold py-2 px-4 rounded-full">
